...
public class RocketsWeapon : ProjectileWeapon
{
    ...
    public override void Fire()
    {
        ...
        bullet.Initialize(firePoint.position, direction, projectileSpeed, damage,knockBackForce, transform.root.gameObject, rocketData.explosionRadius, rocketData.explosionDelay);
        Ammo--;
        if (Ammo == 0)
        {
